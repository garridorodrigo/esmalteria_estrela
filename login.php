    ...
    <div class="container">
      <div class="row ">
        ...
        <div class="col-md-4 formulario">
          ...
          <form class="form" method="post" action="validar_acesso.php" accept-charset="UTF-8" id="formLogin">
           ...
           <div class="form-group">
             ...
             <input type="password" class="form-control" id="senha" name="senha" placeholder="Senha" >
              <!--<div class="help-block text-right"><a href="" class="linkEsqueciSenha">Esqueceu a senha?</a></div>-->
           </div>
           <div class="form-group">
          ...
          <a class="btn btn-secondary btn-block btnFechar" role="button" value="Voltar"  href="index.html" id="btnfechar" type="button">Voltar</a>
           ...
           <div class="bottom text-right">
            Novo(a) aqui? <a href="cadastrar.html" class="linkCadastrar"><b>Cadastre-se</b></a>
          </div>
        </form>
